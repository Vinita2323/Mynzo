      ...
      <div className="flex justify-between items-center">
        ...
        {!isAdding && !editingId && (
          <button
            ...
            className="px-4 py-2 bg-[#ee4923] text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-md flex items-center gap-1.5"
          >
