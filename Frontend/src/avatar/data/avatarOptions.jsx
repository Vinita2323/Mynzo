...
export const OUTFIT_COLORS = [
  { id: "black", value: "#1A1A1A", label: "Black" },
  { id: "orange", value: "#FF6E54", label: "Orange" },
...
export const BACKGROUNDS = [
  { id: "gradient_orange", value: "linear-gradient(135deg, #FF6E54 0%, #FF8E4D 100%)", label: "Orange Glow" },
  ...
  },
  {
    ...
    render: () => (
      <g>
        ...
        {/* Brim */}
        <path d="M 15 45 Q 50 35 85 45 Q 50 50 15 45 Z" fill="#FF6E54" />
      </g>
    )
  }
];
