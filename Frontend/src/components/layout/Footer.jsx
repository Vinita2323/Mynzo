    ...
    <footer className="bg-[#0F172A] text-slate-400 py-12 px-6 mt-16 border-t border-slate-800 text-sm mb-16 md:mb-0 select-none">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-8">
          ...
          <div className="grid grid-cols-2 gap-6 text-xs md:col-span-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-slate-400 font-medium">
                <li><a href="#/categories?cat=gifting" className="hover:text-[#ee4923] transition-colors">Gift Hampers</a></li>
                <li><a href="#/categories?cat=toys" className="hover:text-[#ee4923] transition-colors">Teddy Bears & Plush</a></li>
                <li><a href="#/categories?cat=electronics" className="hover:text-[#ee4923] transition-colors">RC Toys & Gadgets</a></li>
                <li><a href="#/categories?cat=jewellery" className="hover:text-[#ee4923] transition-colors">Sterling Pendants</a></li>
              </ul>
            </div>
            <div className="space-y-3">
          ...
          <div className="md:col-span-3 space-y-3 flex flex-col justify-center">
            <div className="flex items-start gap-2.5 bg-slate-800/30 p-4 rounded-xl border border-slate-800/80">
              <ShieldCheck className="w-5 h-5 text-[#ee4923] flex-shrink-0 mt-0.5" />
        ...
        <div className="border-t border-slate-800/80 pt-6 text-center text-[10px] space-y-1.5 text-slate-500">
          <p>© {new Date().getFullYear()} Mynzo World Private Limited. All rights reserved.</p>
