    ...
    <div className="bg-slate-50 min-h-screen font-sans pb-20 select-none">
      ...
      <div className="max-w-5xl mx-auto w-full px-0 md:px-6 py-4 md:py-8 space-y-6">
        ...
        <div className="hidden md:flex justify-between items-center border-b border-slate-200 pb-3">
          ...
          <button 
            onClick={() => navigate(-1)}
            className="px-3.5 py-1.5 bg-white hover:bg-slate-50 border border-slate-200 rounded-lg text-slate-650 text-xs font-bold transition-all shadow-3xs cursor-pointer"
          >
            Go Back
          </button>
        </div>
        ...
        {/* Intro Banner */}
        <div className="bg-gradient-to-br from-orange-50 to-[#FFE4D6] rounded-2xl p-5 border border-orange-100 shadow-3xs relative overflow-hidden mx-3 md:mx-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start px-3 md:px-0">
          ...
          <div className="md:col-span-7 bg-white p-5 rounded-2xl border border-slate-100 shadow-3xs space-y-4">
              ...
              <form onSubmit={handleSubmitTicket} className="space-y-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-50 border border-slate-100 rounded-xl py-3 px-4 text-xs font-bold text-slate-705 outline-none focus:border-orange-500 transition-all appearance-none cursor-pointer"
                  >
                ...
                <button 
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-[#ee4923] text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-orange-100 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
          ...
          <div className="md:col-span-5 space-y-5">
            ...
            <a href={`tel:${supportPhone}`} className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-3xs border border-slate-100 hover:border-[#ee4923] hover:shadow-md transition-all group">
            ...
            <a href={`mailto:${supportEmail}`} className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-3xs border border-slate-100 hover:border-[#ee4923] hover:shadow-md transition-all group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {myTickets.map((ticket) => (
                  <div 
                    ...
                    className="bg-white p-4 rounded-2xl border border-slate-100 shadow-3xs flex items-start justify-between gap-3 cursor-pointer hover:border-orange-500 hover:shadow-sm transition-all active:scale-[0.99]"
                  >
              ...
              {faqs.map((faq, index) => (
                <div 
                  ...
                  className={`border-b border-slate-100 last:border-0 ${
                    openFaqIndex === index ? 'bg-orange-50/20' : 'hover:bg-slate-50'
                  } transition-colors`}
                >
                  <button
                  ...
                  >
                    <span className={`text-xs md:text-sm font-black ${openFaqIndex === index ? 'text-[#ee4923]' : 'text-[#02006c]'}`}>
                      {faq.question}
                    </span>
                    <ChevronDown 
