...
const sections = [
  {
    ...
    content:
      'By accessing or using Mynzo World, you agree to be bound by these Terms & Conditions and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.',
  },
  {
    icon: ShieldCheck,
    iconBg: 'bg-violet-50',
  ...
  },
  {
    ...
    content:
      'The Service and its original content, features, and functionality are and will remain the exclusive property of Mynzo World and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without prior written consent.',
  },
  {
    icon: AlertTriangle,
    iconBg: 'bg-rose-50',
    ...
    content:
      'In no event shall Mynzo World, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.',
  },
  {
    icon: FileText,
    iconBg: 'bg-orange-50',
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-500 font-medium leading-snug">
              Reach out to us at{' '}
              <a href="mailto:support@mynzo.com" className="text-[#ee4923] font-bold hover:underline">
                support@mynzo.com
              </a>{' '}
